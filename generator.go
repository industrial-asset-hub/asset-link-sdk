...
//go:generate protoc --proto_path=specs --go_out ./generated      --go_opt=Mconn_suite_command.proto=./conn_suite_command     specs/conn_suite_command.proto
//go:generate protoc --proto_path=specs --go-grpc_out ./generated --go-grpc_opt=Mconn_suite_command.proto=./conn_suite_command specs/conn_suite_command.proto
...
//go:generate protoc --proto_path=specs --go_out ./generated      --go_opt=Mconn_suite_device_info.proto=./conn_suite_device_info     specs/conn_suite_device_info.proto
//go:generate protoc --proto_path=specs --go-grpc_out ./generated --go-grpc_opt=Mconn_suite_device_info.proto=./conn_suite_device_info specs/conn_suite_device_info.proto
...
//go:generate protoc --proto_path=specs --go_out      ./generated --go_opt=Miah_discover.proto=./iah-discovery --go_opt=Mcommon_address.proto=./iah-discovery --go_opt=Mcommon_variant.proto=./iah-discovery --go_opt=Mcommon_operators.proto=./iah-discovery --go_opt=Mcommon_filters.proto=./iah-discovery  --go_opt=Mcommon_identifiers.proto=./iah-discovery --go_opt=Mcommon_code.proto=./iah-discovery --go_opt=Mcommon_datatype.proto=./iah-discovery --go_opt=Mcommon_properties.proto=./iah-discovery iah_discover.proto common_address.proto common_variant.proto common_operators.proto common_filters.proto common_identifiers.proto common_code.proto common_datatype.proto common_properties.proto
//go:generate protoc --proto_path=specs --go-grpc_out ./generated --go-grpc_opt=Miah_discover.proto=./iah-discovery --go-grpc_opt=Mcommon_address.proto=./iah-discovery --go-grpc_opt=Mcommon_variant.proto=./iah-discovery --go-grpc_opt=Mcommon_operators.proto=./iah-discovery --go-grpc_opt=Mcommon_filters.proto=./iah-discovery  --go-grpc_opt=Mcommon_identifiers.proto=./iah-discovery --go-grpc_opt=Mcommon_code.proto=./iah-discovery --go-grpc_opt=Mcommon_datatype.proto=./iah-discovery --go-grpc_opt=Mcommon_properties.proto=./iah-discovery iah_discover.proto common_identifiers.proto
