...
func (d *DeviceInfo) ConvertToDiscoveredDevice() *generated.DiscoveredDevice {
	return ConvertFromDerivedSchemaToDiscoveredDevice(d, "https://schema.industrial-assets.io/base/v0.10.0", "Asset")
}

func (r *DeviceRelationshipInfo) ConvertToDiscoveredDeviceRelationship() *generated.DiscoveredDevice {
	return ConvertFromDerivedSchemaToDiscoveredDevice(r, "https://schema.industrial-assets.io/base/v0.10.0", "DeviceRelationship")
}
