...
// Pattern constants for validation - sourced from cdm_base.schema_v1.20.0.json
const (
	...
	// PredicatePattern validates asset relation predicates (e.g., is_module_of, is_component_of).
	PredicatePattern = "^[a-z][a-z0-9]*(_[a-z0-9]+)*$"
