...
type ArtifactChecksum struct {
	...
	// identifiers provided by a Device Class Driver. The highest the number, the more
	...
	// This index helps decide across DCDs which identifiers are better suited for
	// deduplication. The identifier provided by two different DCDs with the lowest
	// uncertainty should be chosen for deduplication purposes.
...
// that is known to CDM. CDM might want to manage the asset, to model its
// relationships with other assets, it might know the asset and ignore it,...
...
type Asset struct {
	...
	ConnectionPoints []ConnectionPoint `json:"connection_points,omitempty" yaml:"connection_points,omitempty" mapstructure:"connection_points,omitempty"`

	// Metadata associated with Asset in User Interface
	CustomUiProperties []InstanceAnnotation `json:"custom_ui_properties,omitempty" yaml:"custom_ui_properties,omitempty" mapstructure:"custom_ui_properties,omitempty"`
	...
	FunctionalParts []Asset `json:"functional_parts,omitempty" yaml:"functional_parts,omitempty" mapstructure:"functional_parts,omitempty"`
	...
	// assets might be known to the CDM Asset Management system (for example,
	// discovered through a network scan), but want to be ignored for different
	// reasons.
	...
	// modeling.
	SoftwareComponents []SoftwareAsset `json:"software_components,omitempty" yaml:"software_components,omitempty" mapstructure:"software_components,omitempty"`
}
...
type CdmBaseSchemaV070Json map[string]interface{}
...
type ConnectionPoint struct {
	...
	ConnectionPointType *string `json:"connection_point_type,omitempty" yaml:"connection_point_type,omitempty" mapstructure:"connection_point_type,omitempty"`
...
type Device struct {
	...
	// AssetLinks, if desired. Once again it probably goes beyond the purpose of asset
	// modeling.
	SoftwareComponents []SoftwareAsset `json:"software_components" yaml:"software_components" mapstructure:"software_components"`
}
...
type Gateway struct {
	...
	// List of DCDs running on a Gateway and registered.
...
// The reachability_state based on when an ƒ that can be contacted (typically a
