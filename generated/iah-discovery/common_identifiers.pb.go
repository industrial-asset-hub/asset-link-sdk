...
func (x *IdentifierRequest) GetIdentifier() isIdentifierRequest_Identifier {
	if x != nil {
		return x.Identifier
	}
	return nil
...
func (x *IdentifierRequest) GetSemantic() *SemanticClassifier {
	if x != nil {
		if x, ok := x.Identifier.(*IdentifierRequest_Semantic); ok {
			return x.Semantic
		}
	}
	return nil
...
func (x *IdentifierRequest) GetName() string {
	if x != nil {
		if x, ok := x.Identifier.(*IdentifierRequest_Name); ok {
			return x.Name
		}
	}
	return ""
...
func (x *DeviceIdentifier) GetValue() isDeviceIdentifier_Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *DeviceIdentifier) GetInt64Value() int64 {
	if x != nil {
		if x, ok := x.Value.(*DeviceIdentifier_Int64Value); ok {
			return x.Int64Value
		}
	}
	return 0
...
func (x *DeviceIdentifier) GetUint64Value() uint64 {
	if x != nil {
		if x, ok := x.Value.(*DeviceIdentifier_Uint64Value); ok {
...
func (x *DeviceIdentifier) GetFloat64Value() float64 {
	if x != nil {
		if x, ok := x.Value.(*DeviceIdentifier_Float64Value); ok {
...
func (x *DeviceIdentifier) GetText() string {
	if x != nil {
		if x, ok := x.Value.(*DeviceIdentifier_Text); ok {
			return x.Text
		}
	}
	return ""
...
func (x *DeviceIdentifier) GetRawData() []byte {
	if x != nil {
		if x, ok := x.Value.(*DeviceIdentifier_RawData); ok {
			return x.RawData
		}
	}
	return nil
...
func (x *DeviceIdentifier) GetChildren() *DeviceIdentifierValueList {
	if x != nil {
		if x, ok := x.Value.(*DeviceIdentifier_Children); ok {
			return x.Children
		}
	}
	return nil
...
const file_common_identifiers_proto_rawDesc = "" +
	"\n" +
	"\x18common_identifiers.proto\x12\x1dsiemens.common.identifiers.v1\x1a\x14common_address.proto\"\x88\x01\n" +
	"\x11IdentifierRequest\x12O\n" +
	"\bsemantic\x18\x01 \x01(\v21.siemens.common.identifiers.v1.SemanticClassifierH\x00R\bsemantic\x12\x14\n" +
	"\x04name\x18\x02 \x01(\tH\x00R\x04nameB\f\n" +
	"\n" +
	"identifier\"\xab\x01\n" +
	"\x15GetIdentifiersRequest\x12>\n" +
	"\x06target\x18\x01 \x01(\v2&.siemens.common.address.v1.DestinationR\x06target\x12R\n" +
	"\videntifiers\x18\x02 \x03(\v20.siemens.common.identifiers.v1.IdentifierRequestR\videntifiers\"k\n" +
	"\x16GetIdentifiersResponse\x12Q\n" +
	"\videntifiers\x18\x01 \x03(\v2/.siemens.common.identifiers.v1.DeviceIdentifierR\videntifiers\"\x1e\n" +
	"\x1cGetSupportedSemanticsRequest\"\x7f\n" +
	"\x1dGetSupportedSemanticsResponse\x12^\n" +
	"\x11supportedSemantic\x18\x01 \x03(\v20.siemens.common.identifiers.v1.SupportedSemanticR\x11supportedSemantic\"b\n" +
	"\x19DeviceIdentifierValueList\x12E\n" +
	"\x05value\x18\x01 \x03(\v2/.siemens.common.identifiers.v1.DeviceIdentifierR\x05value\"\xea\x02\n" +
	...
	"\braw_data\x18\x06 \x01(\fH\x00R\arawData\x12V\n" +
	"\bchildren\x18\a \x01(\v28.siemens.common.identifiers.v1.DeviceIdentifierValueListH\x00R\bchildren\x12S\n" +
	"\vclassifiers\x18\b \x03(\v21.siemens.common.identifiers.v1.SemanticClassifierR\vclassifiersB\a\n" +
	"\x05value\"|\n" +
	"\x11SupportedSemantic\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12S\n" +
	"\vclassifiers\x18\x02 \x03(\v21.siemens.common.identifiers.v1.SemanticClassifierR\vclassifiers\">\n" +
	"\x12SemanticClassifier\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value2\xa8\x02\n" +
	"\x0eIdentifiersApi\x12\x7f\n" +
	"\x0eGetIdentifiers\x124.siemens.common.identifiers.v1.GetIdentifiersRequest\x1a5.siemens.common.identifiers.v1.GetIdentifiersResponse\"\x00\x12\x94\x01\n" +
	"\x15GetSupportedSemantics\x12;.siemens.common.identifiers.v1.GetSupportedSemanticsRequest\x1a<.siemens.common.identifiers.v1.GetSupportedSemanticsResponse\"\x00b\x06proto3"

var (
	file_common_identifiers_proto_rawDescOnce sync.Once
	file_common_identifiers_proto_rawDescData []byte
)

func file_common_identifiers_proto_rawDescGZIP() []byte {
	file_common_identifiers_proto_rawDescOnce.Do(func() {
		file_common_identifiers_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_common_identifiers_proto_rawDesc), len(file_common_identifiers_proto_rawDesc)))
	})
...
func file_common_identifiers_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_identifiers_proto_rawDesc), len(file_common_identifiers_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
