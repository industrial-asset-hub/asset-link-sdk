...
var file_conn_suite_registry_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x22, 0x88, 0x02, 0x0a, 0x0b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x49, 0x6e,
	...
	0x79, 0x70, 0x65, 0x73, 0x12, 0x2c, 0x0a, 0x12, 0x64, 0x72, 0x69, 0x76, 0x65, 0x72, 0x5f, 0x73,
	...
	0x76, 0x69, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x88, 0x01, 0x0a,
	...
	0x65, 0x6d, 0x61, 0x55, 0x72, 0x69, 0x73, 0x22, 0x72, 0x0a, 0x1e, 0x51, 0x75, 0x65, 0x72, 0x79,
...
var file_conn_suite_registry_proto_goTypes = []interface{}{
...
func file_conn_suite_registry_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_conn_suite_registry_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_conn_suite_registry_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_conn_suite_registry_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_conn_suite_registry_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_conn_suite_registry_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_conn_suite_registry_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ServiceInfoFilter); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_conn_suite_registry_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryRegisteredServicesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_conn_suite_registry_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryRegisteredServicesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_conn_suite_registry_proto_msgTypes[0].OneofWrappers = []interface{}{
