...
const (
	...
	ArtefactType_AT_LOGFILE       ArtefactType = 3
)
...
type ArtefactChunk_Metadata struct {
	Metadata *ArtefactMetaData `protobuf:"bytes,1,opt,name=metadata,proto3,oneof"` // first packet for PushArtefact
}
...
type ArtefactMetaData struct {
	...
	ArtefactIdentifier  *ArtefactIdentifier  `protobuf:"bytes,1,opt,name=artefact_identifier,json=artefactIdentifier,proto3" json:"artefact_identifier,omitempty"`
	ArtefactCredentials *ArtefactCredentials `protobuf:"bytes,2,opt,name=artefact_credentials,json=artefactCredentials,proto3" json:"artefact_credentials,omitempty"`
	DeviceIdentifier    *DeviceIdentifier    `protobuf:"bytes,3,opt,name=device_identifier,json=deviceIdentifier,proto3" json:"device_identifier,omitempty"`
	DeviceCredentials   *DeviceCredentials   `protobuf:"bytes,4,opt,name=device_credentials,json=deviceCredentials,proto3" json:"device_credentials,omitempty"`
}
...
var file_artefact_update_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_artefact_update_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_artefact_update_proto_goTypes = []any{
	...
	(*ArtefactIdentifier)(nil),      // 5: factory_x.artefact_update.v1.ArtefactIdentifier
	(*ArtefactCredentials)(nil),     // 6: factory_x.artefact_update.v1.ArtefactCredentials
	(*DeviceIdentifier)(nil),        // 7: factory_x.artefact_update.v1.DeviceIdentifier
	(*DeviceCredentials)(nil),       // 8: factory_x.artefact_update.v1.DeviceCredentials
	(*ArtefactOperationStatus)(nil), // 9: factory_x.artefact_update.v1.ArtefactOperationStatus
}
var file_artefact_update_proto_depIdxs = []int32{
	...
	9,  // 1: factory_x.artefact_update.v1.ArtefactChunk.status:type_name -> factory_x.artefact_update.v1.ArtefactOperationStatus
	5,  // 2: factory_x.artefact_update.v1.ArtefactMetaData.artefact_identifier:type_name -> factory_x.artefact_update.v1.ArtefactIdentifier
	6,  // 3: factory_x.artefact_update.v1.ArtefactMetaData.artefact_credentials:type_name -> factory_x.artefact_update.v1.ArtefactCredentials
	7,  // 4: factory_x.artefact_update.v1.ArtefactMetaData.device_identifier:type_name -> factory_x.artefact_update.v1.DeviceIdentifier
	8,  // 5: factory_x.artefact_update.v1.ArtefactMetaData.device_credentials:type_name -> factory_x.artefact_update.v1.DeviceCredentials
	0,  // 6: factory_x.artefact_update.v1.ArtefactIdentifier.type:type_name -> factory_x.artefact_update.v1.ArtefactType
	2,  // 7: factory_x.artefact_update.v1.ArtefactOperationStatus.phase:type_name -> factory_x.artefact_update.v1.ArtefactOperationPhase
	1,  // 8: factory_x.artefact_update.v1.ArtefactOperationStatus.state:type_name -> factory_x.artefact_update.v1.ArtefactOperationState
	3,  // 9: factory_x.artefact_update.v1.ArtefactUpdateApi.PushArtefact:input_type -> factory_x.artefact_update.v1.ArtefactChunk
	4,  // 10: factory_x.artefact_update.v1.ArtefactUpdateApi.PullArtefact:input_type -> factory_x.artefact_update.v1.ArtefactMetaData
	9,  // 11: factory_x.artefact_update.v1.ArtefactUpdateApi.PushArtefact:output_type -> factory_x.artefact_update.v1.ArtefactOperationStatus
	3,  // 12: factory_x.artefact_update.v1.ArtefactUpdateApi.PullArtefact:output_type -> factory_x.artefact_update.v1.ArtefactChunk
