...
type ArtefactTypes int32

const (
	ArtefactTypes_AT_FIRMWARE      ArtefactTypes = 0
	ArtefactTypes_AT_BACKUP        ArtefactTypes = 1
	ArtefactTypes_AT_CONFIGURATION ArtefactTypes = 2
)

// Enum value maps for ArtefactTypes.
var (
	ArtefactTypes_name = map[int32]string{
		0: "AT_FIRMWARE",
		1: "AT_BACKUP",
		2: "AT_CONFIGURATION",
	}
	ArtefactTypes_value = map[string]int32{
		"AT_FIRMWARE":      0,
		"AT_BACKUP":        1,
		"AT_CONFIGURATION": 2,
	}
...
func (x ArtefactTypes) Enum() *ArtefactTypes {
	p := new(ArtefactTypes)
	*p = x
	return p
}

func (x ArtefactTypes) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ArtefactTypes) Descriptor() protoreflect.EnumDescriptor {
	return file_artefact_update_proto_enumTypes[1].Descriptor()
}

func (ArtefactTypes) Type() protoreflect.EnumType {
	return &file_artefact_update_proto_enumTypes[1]
}

func (x ArtefactTypes) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ArtefactTypes.Descriptor instead.
func (ArtefactTypes) EnumDescriptor() ([]byte, []int) {
...
func (x *ArtefactChunk) GetMetaDate() *ArtefactMetaData {
	if x, ok := x.GetData().(*ArtefactChunk_MetaDate); ok {
		return x.MetaDate
	}
	return nil
}
...
type ArtefactChunk_MetaDate struct {
	MetaDate *ArtefactMetaData `protobuf:"bytes,1,opt,name=metaDate,proto3,oneof"`
}
...
func (*ArtefactChunk_MetaDate) isArtefactChunk_Data() {}
...
type ArtefactMetaData struct {
	...
	//
	//	*ArtefactMetaData_Credential
	//	*ArtefactMetaData_DeviceConnectionInformation
	Meta isArtefactMetaData_Meta `protobuf_oneof:"meta"`
}
...
func (m *ArtefactMetaData) GetMeta() isArtefactMetaData_Meta {
	if m != nil {
		return m.Meta
	}
	return nil
...
func (x *ArtefactMetaData) GetCredential() *ArtefactCredentials {
	if x, ok := x.GetMeta().(*ArtefactMetaData_Credential); ok {
		return x.Credential
	}
	return nil
}

func (x *ArtefactMetaData) GetDeviceConnectionInformation() []byte {
	if x, ok := x.GetMeta().(*ArtefactMetaData_DeviceConnectionInformation); ok {
		return x.DeviceConnectionInformation
	}
	return nil
}

type isArtefactMetaData_Meta interface {
	isArtefactMetaData_Meta()
}

type ArtefactMetaData_Credential struct {
	Credential *ArtefactCredentials `protobuf:"bytes,1,opt,name=credential,proto3,oneof"`
}

type ArtefactMetaData_DeviceConnectionInformation struct {
	DeviceConnectionInformation []byte `protobuf:"bytes,2,opt,name=device_connection_information,json=deviceConnectionInformation,proto3,oneof"`
}

func (*ArtefactMetaData_Credential) isArtefactMetaData_Meta() {}

func (*ArtefactMetaData_DeviceConnectionInformation) isArtefactMetaData_Meta() {}
...
type ArtefactType struct {
	...
	Type ArtefactTypes `protobuf:"varint,1,opt,name=type,proto3,enum=factory_x.artefact_update.v1.ArtefactTypes" json:"type,omitempty"`
}

func (x *ArtefactType) Reset() {
	*x = ArtefactType{}
	if protoimpl.UnsafeEnabled {
...
func (*ArtefactType) ProtoMessage() {}

func (x *ArtefactType) ProtoReflect() protoreflect.Message {
	mi := &file_artefact_update_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ArtefactType.ProtoReflect.Descriptor instead.
func (*ArtefactType) Descriptor() ([]byte, []int) {
	return file_artefact_update_proto_rawDescGZIP(), []int{4}
}

func (x *ArtefactType) GetType() ArtefactTypes {
	if x != nil {
		return x.Type
	}
	return ArtefactTypes_AT_FIRMWARE
}
...
var file_artefact_update_proto_rawDesc = []byte{
	...
	0x63, 0x74, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x12, 0x4c, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x44,
	0x61, 0x74, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x66, 0x61, 0x63, 0x74,
	...
	0x61, 0x44, 0x61, 0x74, 0x65, 0x12, 0x23, 0x0a, 0x0c, 0x66, 0x69, 0x6c, 0x65, 0x5f, 0x63, 0x6f,
	...
	0x74, 0x61, 0x22, 0xb5, 0x01, 0x0a, 0x10, 0x41, 0x72, 0x74, 0x65, 0x66, 0x61, 0x63, 0x74, 0x4d,
	0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x12, 0x53, 0x0a, 0x0a, 0x63, 0x72, 0x65, 0x64, 0x65,
	...
	0x61, 0x63, 0x74, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x73, 0x48, 0x00,
	0x52, 0x0a, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x12, 0x44, 0x0a, 0x1d,
	0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0c, 0x48, 0x00, 0x52, 0x1b, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x43, 0x6f, 0x6e,
	0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x42, 0x06, 0x0a, 0x04, 0x6d, 0x65, 0x74, 0x61, 0x22, 0x60, 0x0a, 0x13, 0x41, 0x72,
	...
	,
	...
	,
...
var file_artefact_update_proto_goTypes = []interface{}{
	(TransferStatus)(0),          // 0: factory_x.artefact_update.v1.TransferStatus
	(ArtefactTypes)(0),           // 1: factory_x.artefact_update.v1.ArtefactTypes
	...
	(*ArtefactType)(nil),         // 7: factory_x.artefact_update.v1.ArtefactType
	(*ArtefactUpdateStatus)(nil), // 8: factory_x.artefact_update.v1.ArtefactUpdateStatus
}
var file_artefact_update_proto_depIdxs = []int32{
	4, // 0: factory_x.artefact_update.v1.ArtefactChunk.metaDate:type_name -> factory_x.artefact_update.v1.ArtefactMetaData
	...
	0, // 3: factory_x.artefact_update.v1.Status.status:type_name -> factory_x.artefact_update.v1.TransferStatus
	1, // 4: factory_x.artefact_update.v1.ArtefactType.type:type_name -> factory_x.artefact_update.v1.ArtefactTypes
	6, // 5: factory_x.artefact_update.v1.ArtefactUpdateStatus.status:type_name -> factory_x.artefact_update.v1.Status
	2, // 6: factory_x.artefact_update.v1.ArtefactUpdateStatus.state:type_name -> factory_x.artefact_update.v1.ArtefactUpdateState
	3, // 7: factory_x.artefact_update.v1.ArtefactUpdateApi.PushArtefact:input_type -> factory_x.artefact_update.v1.ArtefactChunk
	7, // 8: factory_x.artefact_update.v1.ArtefactUpdateApi.PullArtefact:input_type -> factory_x.artefact_update.v1.ArtefactType
	8, // 9: factory_x.artefact_update.v1.ArtefactUpdateApi.PushArtefact:output_type -> factory_x.artefact_update.v1.ArtefactUpdateStatus
	3, // 10: factory_x.artefact_update.v1.ArtefactUpdateApi.PullArtefact:output_type -> factory_x.artefact_update.v1.ArtefactChunk
...
func file_artefact_update_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_artefact_update_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ArtefactChunk); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_artefact_update_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ArtefactMetaData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_artefact_update_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ArtefactCredentials); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_artefact_update_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Status); i {
			case 0:
				return &v.state
			case 1:
		...
		file_artefact_update_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ArtefactType); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_artefact_update_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ArtefactUpdateStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_artefact_update_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*ArtefactChunk_MetaDate)(nil),
		(*ArtefactChunk_FileContent)(nil),
		(*ArtefactChunk_Status)(nil),
	}
	file_artefact_update_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*ArtefactMetaData_Credential)(nil),
		(*ArtefactMetaData_DeviceConnectionInformation)(nil),
	}
	type x struct{}
