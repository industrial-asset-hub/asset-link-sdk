...
type JobIdenfifier struct {
	...
	JobId string `protobuf:"bytes,1,opt,name=job_id,json=jobId,proto3" json:"job_id,omitempty"` //JobType job_type = 2;
}
...
type ArtefactUpdateMessage struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	//
	//	*ArtefactUpdateMessage_Status
	//	*ArtefactUpdateMessage_Request
	Message isArtefactUpdateMessage_Message `protobuf_oneof:"message"`
}

func (x *ArtefactUpdateMessage) Reset() {
	*x = ArtefactUpdateMessage{}
	mi := &file_artefact_update_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ArtefactUpdateMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ArtefactUpdateMessage) ProtoMessage() {}

func (x *ArtefactUpdateMessage) ProtoReflect() protoreflect.Message {
	mi := &file_artefact_update_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ArtefactUpdateMessage.ProtoReflect.Descriptor instead.
func (*ArtefactUpdateMessage) Descriptor() ([]byte, []int) {
	return file_artefact_update_proto_rawDescGZIP(), []int{9}
}

func (m *ArtefactUpdateMessage) GetMessage() isArtefactUpdateMessage_Message {
	if m != nil {
		return m.Message
	}
	return nil
...
func (x *ArtefactUpdateMessage) GetStatus() *ArtefactOperationStatus {
	if x, ok := x.GetMessage().(*ArtefactUpdateMessage_Status); ok {
		return x.Status
	}
	return nil
}

func (x *ArtefactUpdateMessage) GetRequest() *ArtefactOperationRequest {
	if x, ok := x.GetMessage().(*ArtefactUpdateMessage_Request); ok {
		return x.Request
	}
	return nil
}

type isArtefactUpdateMessage_Message interface {
	isArtefactUpdateMessage_Message()
}

type ArtefactUpdateMessage_Status struct {
	Status *ArtefactOperationStatus `protobuf:"bytes,1,opt,name=status,proto3,oneof"`
}

type ArtefactUpdateMessage_Request struct {
	Request *ArtefactOperationRequest `protobuf:"bytes,2,opt,name=request,proto3,oneof"`
}

func (*ArtefactUpdateMessage_Status) isArtefactUpdateMessage_Message() {}

func (*ArtefactUpdateMessage_Request) isArtefactUpdateMessage_Message() {}
...
var file_artefact_update_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x43, 0x68, 0x75, 0x6e, 0x6b, 0x1a, 0x33, 0x2e, 0x66, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x5f,
	0x78, 0x2e, 0x61, 0x72, 0x74, 0x65, 0x66, 0x61, 0x63, 0x74, 0x5f, 0x75, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x72, 0x74, 0x65, 0x66, 0x61, 0x63, 0x74, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01,
	0x12, 0x78, 0x0a, 0x0e, 0x41, 0x63, 0x74, 0x69, 0x76, 0x61, 0x74, 0x65, 0x55, 0x70, 0x64, 0x61,
	...
	0x33, 0x2e, 0x66, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x5f, 0x78, 0x2e, 0x61, 0x72, 0x74, 0x65,
	0x66, 0x61, 0x63, 0x74, 0x5f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x41,
	0x72, 0x74, 0x65, 0x66, 0x61, 0x63, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_artefact_update_proto_goTypes = []any{
	...
	(*ArtefactUpdateMessage)(nil),     // 13: factory_x.artefact_update.v1.ArtefactUpdateMessage
}
var file_artefact_update_proto_depIdxs = []int32{
	...
	11, // 11: factory_x.artefact_update.v1.ArtefactUpdateMessage.status:type_name -> factory_x.artefact_update.v1.ArtefactOperationStatus
	12, // 12: factory_x.artefact_update.v1.ArtefactUpdateMessage.request:type_name -> factory_x.artefact_update.v1.ArtefactOperationRequest
	...
	11, // 17: factory_x.artefact_update.v1.ArtefactUpdateApi.PushArtefact:output_type -> factory_x.artefact_update.v1.ArtefactOperationStatus
	4,  // 18: factory_x.artefact_update.v1.ArtefactUpdateApi.PullArtefact:output_type -> factory_x.artefact_update.v1.ArtefactChunk
	13, // 19: factory_x.artefact_update.v1.ArtefactUpdateApi.PrepareUpdate:output_type -> factory_x.artefact_update.v1.ArtefactUpdateMessage
	13, // 20: factory_x.artefact_update.v1.ArtefactUpdateApi.ActivateUpdate:output_type -> factory_x.artefact_update.v1.ArtefactUpdateMessage
...
func file_artefact_update_proto_init() {
	...
	file_artefact_update_proto_msgTypes[9].OneofWrappers = []any{
		(*ArtefactUpdateMessage_Status)(nil),
		(*ArtefactUpdateMessage_Request)(nil),
	}
	type x struct{}
