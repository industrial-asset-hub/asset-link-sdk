...
var registerCmd = &cobra.Command{
	Use:   "registration",
	Short: "Run tests for registration",
...
func init() {
	...
	registerCmd.Flags().StringVarP(&grpcEndpoint, "grpc-endpoint", "g", "", "gRPC endpoint for registry")
...
func runRegistrationTests(cmd *cobra.Command, args []string) {
	test.RunRegistrationTests(grpcEndpoint, registryJsonPath)
}
